...
*Control Sir Snake with mouse movement to deflect enemy projectiles BACK at them.| Do not let them hit the shield at the bottom of the screen.

I can't believe it worked, sir.| Why do they keep shooting, even if they see they kill themselves?
Those are drones with a pretty simple programming.| And whoever commands them is probably not much smarter,| attacking Imperial outpost like this.
That gives us a chance.
*Right click toggles Active Pause mode. In that mode, time stops when you don't move.
...
*You can destroy enemies by ramming them at the cost of temporarily losing part of tail.
...
*Bringing our heroes and THAT to the Episode 3 of the Flight of the Snake saga.
*I had no bytes left for any music,|but imagine anything from Space Rangers 2 OST playing now.
*If it's not obvious enough, you have won the game by now.
...
*Yet.
*Thanks for playing! And please, leave feedback on Itch.io
`;
